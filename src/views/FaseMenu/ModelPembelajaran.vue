<template>
    <v-container fluid>
        <MenuTitle msg="Menu | Kurikulum Modul Pembelajaran" class="text-subtitle-1 font-weight-medium " />

        <v-data-table :headers="headers" :items="modul_pembelajaran" :items-per-page="5" class="elevation-5 mt-4">
                        ...
                        <v-card class="py-3 px-2">
                            ...
                            <v-card-text>
                                <v-container class="py-4">
                                    <v-form ref="form">
                                        <v-text-field v-model="forms.tahun_penyusunan"
                                            label="Tahun Penyusunan"></v-text-field>
                                        <v-text-field v-model="forms.bab" label="Bab"></v-text-field>
                                        <v-text-field v-model="forms.tema" label="Tema"></v-text-field>
                                        <v-text-field v-model="forms.alokasi_waktu"
                                        ...
                                        <v-text-field v-model="forms.model_pembelajaran"
                                            label="Model Pembelajaran"></v-text-field>
                                        <v-text-field v-model="forms.tujuan_bab" label="Tujuan Bab"></v-text-field>
                    ...
                    <v-dialog v-model="dialogEdit" max-width="650px">
                        <v-card class="py-3 px-2">
                            ...
                            <v-card-text>
                                <v-container class="py-4">
                                    <v-form ref="form">
                                        <v-text-field v-model="formsEdit.tahun_penyusunan"
                                            label="Tahun Penyusunan"></v-text-field>
                                        <v-text-field v-model="formsEdit.bab" label="Bab"></v-text-field>
                                        <v-text-field v-model="formsEdit.tema" label="Tema"></v-text-field>
                                        <v-text-field v-model="formsEdit.alokasi_waktu"
                                            label="Alokasi Waktu"></v-text-field>
                                        ...
                                        <v-text-field v-model="formsEdit.model_pembelajaran"
                                            label="Model Pembelajaran"></v-text-field>
                                        <v-text-field v-model="formsEdit.tujuan_bab" label="Tujuan Bab"></v-text-field>
...
const getCapaian = async () => {
    try {
        ...
        deskripsiCapaian.value = capaian_pembelajaran.value.map(cp => cp.capaian_pembelajaran);
...
const save = async () => {
    try {
        ...
        const response = await axios.post(`http://localhost:3000/kurikulum/${idMp}/modul_pembelajaran`, newData)
...
const deleteItemConfirm = async () => {
    try {
        const response = await axios.delete(`http://localhost:3000/kurikulum/modul_pembelajaran/${deleteId.value}`)
...
const updateData = async () => {
    try {
        ...
        const response = await axios.put(`http://localhost:3000/kurikulum/modul_pembelajaran/${formsEdit.value.idModul}`, updateData)
        if (response.status === 200) {
